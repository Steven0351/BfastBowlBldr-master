...
class LiquidTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.liquidName.font = UIFont.preferredFont(forTextStyle: UIFontTextStyle.headline)
        cell.liquidName.text = liquidNames[row]
        cell.liquidImage.image = UIImage(named: liquidImages[row])
